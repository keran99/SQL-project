...
link = driver.find_element_by_link_text('Progetto Basi di dati/')
link.click()
...
driver.find_element_by_xpath('/html/body/div/div/div/form/div[4]/input').send_keys("C:/xampp/htdocs/Progetto basi di dati/img/1.jpg")
time.sleep(3)
driver.find_element_by_xpath('/html/body/div/div/div/form/button').click()
time.sleep(4)
...
driver.find_element_by_name("NomeHabitat").send_keys("Lago")
driver.find_element_by_xpath('/html/body/div/div/div/form/div/div/div[4]/input').send_keys("C:/xampp/htdocs/Progetto basi di dati/img/1.jpg")
...
driver.find_element_by_xpath('/html/body/div/div/div/form/div/div[5]/input').send_keys("C:/xampp/htdocs/Progetto basi di dati/img/1.jpg")
time.sleep(18)
